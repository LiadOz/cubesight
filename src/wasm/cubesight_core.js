/* @ts-self-types="./cubesight_core.d.ts" */

/**
 * Return the complete catalog, useful for populating a case filter.
 * @returns {string}
 */
export function case_catalog() {
    let deferred1_0;
    let deferred1_1;
    try {
        const ret = wasm.case_catalog();
        deferred1_0 = ret[0];
        deferred1_1 = ret[1];
 ...
 * @returns {number}
 */
export function case_count() {
    const ret = wasm.case_count();
    return ret;
}
 ...
 * @param {bigint} seed
 * @param {string} bottom_face_or_neutral
 * @returns {string}
 */
export function f2l_case(seed, bottom_face_or_neutral) {
    let deferred2_0;
    let deferred2_1;
    try {
        const ptr0 = passStringToWasm0(bottom_face_or_neutral, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.f2l_case(seed, ptr0, len0);
        deferred2_0 = ret[0];
        deferred2_1 = ret[1];
        return getStringFromWasm0(ret[0], ret[1]);
    } finally {
 ...
 * @returns {string}
 */
export function generate_case(index) {
    let deferred1_0;
    let deferred1_1;
    try {
        const ret = wasm.generate_case(index);
        deferred1_0 = ret[0];
        deferred1_1 = ret[1];
        return getStringFromWasm0(ret[0], ret[1]);
    } finally {
 ...
 * @returns {string}
 */
export function random_case(seed) {
    let deferred1_0;
    let deferred1_1;
    try {
        const ret = wasm.random_case(seed);
        deferred1_0 = ret[0];
        deferred1_1 = ret[1];
        return getStringFromWasm0(ret[0], ret[1]);
    } finally {
 ...
 * @returns {string}
 */
export function score_attempt(case_id, elapsed_ms, correct, history_json) {
    let deferred3_0;
    let deferred3_1;
    try {
        ...
        const ret = wasm.score_attempt(ptr0, len0, elapsed_ms, correct, ptr1, len1);
        deferred3_0 = ret[0];
        deferred3_1 = ret[1];
        return getStringFromWasm0(ret[0], ret[1]);
    } finally {
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('cubesight_core_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
